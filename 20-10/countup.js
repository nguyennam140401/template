...
CountUp.prototype.calculate = function (id) {
    ...
    countainer.innerHTML =
        '<strong>' +
        this.years +
        '</strong> <small>năm</small>' +
        ' <strong>' +
        this.months +
        '</strong> <small>tháng</small>' +
        ' <strong>' +
        this.days +
        '</strong> <small>ngày</small>' +
        ' <strong>' +
        this.hours +
        '</strong> <small>giờ</small>' +
        ' <strong>' +
        this.minutes +
        '</strong> <small>phút</small>' +
        ' <strong>' +
        this.seconds +
        '</strong> <small>giây</small>' +
        ' <strong> ' +
        this.msg +
        ' </strong>'
    var self = this
